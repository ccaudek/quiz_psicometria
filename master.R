...
exams2html(
  here::here("quiz", "07_random_vars", "rand_vars_08.Rmd"),
  encoding = "UTF-8",
  mathjax = TRUE,
...
# Solutions for version 18060400001 ---------------------------------------


c1$"exercise01"$metainfo$solution
c1$"exercise02"$metainfo$solution
c1$"exercise03"$metainfo$solution
c1$"exercise04"$metainfo$solution
c1$"exercise05"$metainfo$solution
c1$"exercise06"$metainfo$solution
c1$"exercise07"$metainfo$solution
c1$"exercise08"$metainfo$solution
c1$"exercise09"$metainfo$solution
c1$"exercise10"$metainfo$solution
c1$"exercise11"$metainfo$solution
c1$"exercise12"$metainfo$solution
c1$"exercise13"$metainfo$solution
c1$"exercise14"$metainfo$solution
c1$"exercise15"$metainfo$solution
c1$"exercise16"$metainfo$solution
c1$"exercise17"$metainfo$solution
c1$"exercise18"$metainfo$solution
c1$"exercise19"$metainfo$solution
c1$"exercise20"$metainfo$solution
c1$"exercise21"$metainfo$solution
c1$"exercise22"$metainfo$solution
c1$"exercise23"$metainfo$solution
c1$"exercise24"$metainfo$solution
c1$"exercise25"$metainfo$solution

...
while(is.null(sc)) {
  ...
  ## solution
  res <- round(as.numeric(out[4, 2]), 2)
  
  ## schoice
  sc <- num_to_schoice(res, range = c(0.5, 8.0), delta = 0.2, digits = 2)
}
```
...
Si trovi la media della distribuzione a posteriori dell'odds-ratio

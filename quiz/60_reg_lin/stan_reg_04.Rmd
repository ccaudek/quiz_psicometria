...
while(is.null(sc)) {
  ...
  inf_cbeta <- round(out[2, 6], 3)

  sol <- as.numeric(inf_cbeta)
...
Si trovi il limite inferiore dell'intervallo di credibilità al 90% per il parametro beta del modello di regressione.

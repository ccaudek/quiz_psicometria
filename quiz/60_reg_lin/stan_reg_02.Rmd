...
Si utilizzi un modello bayesiano che adotta `normal(100, 500)` quale distribuzione a priori per il parameto alpha e `normal(3, 0.5)` quale distribuzione a priori per il parametro beta -- si noti che tale la distribuzione a priori per beta, in generale, non è giustificata: la utilizziamo qui solo per fare un esercizio. Per sigma si usi `sigma ~ normal(100, 500)`.

...
while(is.null(sc)) {
  ...
  dcohen <- out[4, 2] 
  sol <- as.numeric(dcohen)
  sc <- num_to_schoice(sol, range = c(0.01, 1.5), delta = 0.1, digits = 3)
...
Si calcoli una stima a posteriori della dimensione dell'effetto tramite l'indice $d$ di Cohen.

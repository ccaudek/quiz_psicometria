...
sum(samples > 0.25 & samples < 0.5) / 1e5
\end{verbatim}
\end{solution}

\exname{rethinking_cap2_10}
\extype{schoice}
\exsolution{10000}
\exshuffle{TRUE}

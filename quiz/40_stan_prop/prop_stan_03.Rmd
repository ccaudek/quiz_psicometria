...
## parameters
  ...
  out <- fit$summary()
  post_mean <- as.numeric(out[2, 2])
  ## solution
  res <- round(post_mean, 3)
...
Si calcoli la media della distribuzione a posteriori del parametro $\theta$ (si utilizzino 10000 iterazioni con un warmup di 2000. Per la riproducibilità dei risultati, si usi `seed = 84735`).

...
while(is.null(sc)) {
  ...
  m <- sample(15:30, 1)
  # quantile
  q <- sample(1:m, 1) # ignore the value 0
  res <- extraDistr::pbbinom(q, m, alpha = shape1_post, beta = shape2_post)
...
========
  ...
  q <- sample(1:(m-5), 1) # ignore the value 0

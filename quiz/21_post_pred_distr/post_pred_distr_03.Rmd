...
while(is.null(sc)) {
  ...
  res <- 1 - extraDistr::pbbinom(q, m, alpha = shape1_post, beta = shape2_post)
...
========
  ...
  q <- sample(15:(m-2), 1) # ignore the value 0
